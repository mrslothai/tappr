        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12 mb-8 animate-scale-in">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#25D366] hover:bg-[#1eab52] text-white rounded-xl font-medium transition-all duration-200 hover:scale-105 shadow-lg"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#0077B5] hover:bg-[#006399] text-white rounded-xl font-medium transition-all duration-200 hover:scale-105 shadow-lg"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-xl font-medium transition-all duration-200"
              >
                {copied ? (
                  <>
          ...
          <div className="text-center">
            <button
              ...
              className="inline-flex items-center gap-2 text-white hover:text-white/80 font-medium text-lg transition-colors"
            >
              Go to Dashboard
