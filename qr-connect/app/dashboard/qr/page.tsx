    ...
    >
      ...
      <div className="text-center animate-fade-in">
        ...
        <button
          ...
          className="mt-8 inline-flex items-center gap-3 px-6 py-3 bg-[#25D366] hover:bg-[#1eab52] text-white rounded-xl font-medium transition-all duration-200 hover:scale-105 shadow-lg"
        >
